...
def main():
    ...
    if V3 and V2:
        print("Stiamo utilizzando la V3:")
    elif V2:
        print("Stiamo utilizzando la V2:")
    elif not V3 and not V3:
        print("Stiamo utilizzando la V1:")
    else:
        print("Utilizzando una versione ibrida: ")
